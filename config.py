...
CHALLENGE_UPDATE_INTERVAL = int(os.getenv('CHALLENGE_UPDATE_INTERVAL', 10))
LEADERBOARD_UPDATE_INTERVAL = int(os.getenv('LEADERBOARD_UPDATE_INTERVAL', 15))
ADMIN_MONITOR_INTERVAL = int(os.getenv('ADMIN_MONITOR_INTERVAL', 5))
...
# Admin monitoring thresholds
ADMIN_BIG_WIN_TRX = float(os.getenv('ADMIN_BIG_WIN_TRX', 5000))
ADMIN_HOT_WALLET_MIN_TRX = float(os.getenv('ADMIN_HOT_WALLET_MIN_TRX', 300))
ADMIN_SPIKE_GAMES_PER_MIN = int(os.getenv('ADMIN_SPIKE_GAMES_PER_MIN', 50))

EMERGENCY_STOP = os.getenv('EMERGENCY_STOP', 'false').lower() in {'1', 'true', 'yes'}